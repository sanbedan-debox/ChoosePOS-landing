      ...
      <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-1">
            <h4 className="text-white text-18 font-bold">{title}</h4>
            <p className="text-white text-14">{subtitle}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <section className="max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      ...
      <div className="flex justify-end mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-500px xl:max-w-734px xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          <h2 className="text-white text-24 md:text-32 2xl:text-64 capitalize">
