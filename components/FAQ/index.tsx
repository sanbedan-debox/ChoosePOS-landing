...
const FAQComponent: React.FC = () => {
  return (
    <div className="max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-between mt-20">
          ...
          <li className="text-left mb-10">
            <div className="flex flex-row items-start mb-5">
              <div
                ...
                className="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full text-white border-4 border-white text-xl font-semibold"
              >
                <svg
                  width="30px"
                  fill="black"
              ...
              <div className="bg-green-100 p-5 px-10 w-full flex items-center">
                <h4 className="text-md leading-6 font-medium text-black">
            ...
            <div className="flex flex-row items-start">
              <div className="bg-green-200 p-5 px-10 w-full flex items-center">
              ...
              <div
                ...
                className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full text-white border-4 border-white text-xl font-semibold"
              >
                <svg
                  height="25px"
                  fill="black"
                  ...
                  enableBackground="new 0 0 295.238 295.238"
                >
                  <g>
                    <g>
                      <g>
          ...
          <li className="text-left mb-10">
            <div className="flex flex-row items-start mb-5">
              <div
                ...
                className="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full text-white border-4 border-white 
