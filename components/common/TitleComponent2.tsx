...
const TitleComponent2: React.FC = () => {
  return (
    <div
      className={cn(
        "row-span-1 relative overflow-hidden  mb-35 py-8 md:py-12 justify-center items-center group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none flex flex-col space-y-4 bg-white"
      )}
    >
