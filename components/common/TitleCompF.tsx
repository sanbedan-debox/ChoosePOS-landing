...
const TitleCompF: React.FC = () => {
  return (
    <div className="mb-12 md:mb-35">
      <div className="relative row-span-1 overflow-hidden mb-8 md:mb-24 px-10 md:px-2 py-8 md:py-12 justify-center items-center group hover:shadow-xl transition duration-200 shadow-input dark:shadow-none flex flex-col space-y-4 z-[20]">
        <div
          className="absolute inset-0"
          style={{
            backgroundImage: `url(${group4.src})`,
