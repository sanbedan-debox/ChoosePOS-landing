...
//     <section
//       id="feat"
//       className="flex flex-col items-center overflow-hidden bg-feature-bg h-screen"
//     >
// <div className="mx-auto max-w-[1440px] px-6 lg:px-20 3xl:px-0 relative w-full flex h-full">
...
//         <div className="z-20 flex w-full flex-col lg:w-[60%] h-full">
//           <div className="relative">
//             <h2 className="text-3xl sm:text-5xl lg:text-6xl lg:mt-20">
//               Our{" "}
